...
<body class="page-user no-touch">
	...
	<div class="main-content col-12">
			<div class="content-area card">
				<div class="card-innr">
					<div class="content">
						<h4 class="text-secondary">Профиль (СКОРО)</h4>
						 <h6 Скоро>
						      </h6>
                                                                           
					 <p>Ник- Скоро<?=$login?></p>
					 <p>Пароль- Скоро<?= $pass?></p>
					 <p>ID- Скоро<?=$id?></p>
					 <p>Баланс- Скоро </span><span style="color:blue"   style="    color: #fff;font-weight: 500;font-size: 1.6em;line-height: 1;letter-spacing: -0.02em;" mybalance="0.00" class="odometer" id="userBalance"></span> </p>
				</div>
			</div><!-- .card -->
		</div><!-- .col -->
	</div><!-- .row -->

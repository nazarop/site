            ...
            <div class="container">
                <div class="navbar-innr">
                    <ul class="navbar-menu des">
                                          <li ><a href="/sotr/promo">Промокоды</a></li>
	...
	<div class="card-innr">
		<div class="card-head">
			...
			<h4 class="card-title card-title-lg mob-t" style='float:left; padding-top:8px;'>Промокоды</h4>
                      <button class="btn-ccc btn btn-sm btn-outline btn-light input-bordered col-12" style="float:right; width:120px" data-toggle="modal" data-target="#promo" >Добавить <i class="fas fa-plus icon-edit"></i></button><br><br>
            <hr>          
		</div>
                     <div class="card-text"> 
...
<!-- MODAL -->
    <div class="modal fade show infotbl" id="promo" tabindex="-1" style="display: none;">
